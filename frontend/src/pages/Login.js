            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  autoCorrect="off"
                  spellCheck="false"
                  className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all text-base"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    autoCapitalize="none"
                    autoCorrect="off"
                    className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all pr-12 text-base"
                    style={{ fontSize: '16px' }} // Prevent iOS zoom on focus
                  />
                  <button
                    type="button"
