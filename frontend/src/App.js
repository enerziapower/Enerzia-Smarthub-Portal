    ...
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="projects">
          ...
          {/* Order Summary (renamed from Order Handoff) - Sales to Projects Integration */}
          <Route path="order-handoff" element={<OrderHandoff />} />
          {/* Weekly Billing */}
          <Route path="weekly-billing" element={<WeeklyBilling />} />
        </Route>
        ...
        <Route path="hr">
          ...
          <Route path="advances" element={<AdvancesLoans />} />
        ...
        <Route path="business-hub">
          ...
          <Route path="orders" element={<BizOrderManagement />} />
          <Route path="projects" element={<BizProjectManagement />} />
