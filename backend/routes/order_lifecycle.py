...
async def create_order(data: OrderCreate):
    ...
    lifecycle_data = {
        ...
        "others_budget": {"type": "value", "value": data.others_budget, "amount": data.others_budget},
        "target_profit": {"type": "amount", "value": data.target_profit, "amount": data.target_profit},
        "payment_milestones": [],
